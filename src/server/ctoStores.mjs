...
// before prompt_async. Owned by ctoAdmission.mjs. STRICT (blocker 4): a
// top-level null/array/scalar payload and unparsable JSON/read errors FAIL
// loudly — the corrupt file is never silently reset or overwritten (a
